						...
						<li class="icons dropdown">
							<div class="user-img c-pointer position-relative"
								...
								<span class="activity active"></span> <img
									src="${aprilContext}/views/images/user/1.png" height="40"
									width="40" alt="">
							</div>
				...
				<ul class="metismenu" id="menu">
					...
					<li class="mega-menu mega-menu-sm"><a class="has-arrow"
						...
						<ul aria-expanded="false">
							...
							<li><a href="${aprilContext}/views/layout-one-column.html">One
									Column</a></li>
							<li><a href="${aprilContext}/views/layout-two-column.html">Two
									column</a></li>
							<li><a href="${aprilContext}/views/layout-compact-nav.html">Compact
									Nav</a></li>
					...
					<li><a class="has-arrow" href="javascript:doRetrieve();"
							...
							<div class="card-body">
								<div class="email-left-box">
									<a href="${aprilContext}/views/email_compose.jsp"
										class="btn btn-primary btn-block">메일 쓰기</a> <a
										href="${aprilContext}/views/email_composeVacation.jsp"
										class="btn btn-primary btn-block">휴가 신청서 쓰기</a>
									<div class="mail-list mt-4">
										<a href="${aprilContext}/views/email_inbox.jsp"
										...
										</a> <a href="${aprilContext}/views/email_sentbox.jsp"
											class="list-group-item border-0 p-r-0"><i
											class="fa fa-paper-plane font-18 align-middle mr-2"></i>보낸
											메일함</a> <a href="#" class="list-group-item border-0 p-r-0"><i
															...
															<c:forEach var="vo" items="${list}">
																<tr style="text-align: center;">
																	<td width="3%"><input type="checkbox"
																		onclick="event.cancelBubble=true" name="checkbox"
																		value="${vo.mailId}"></td>
																	<td width="4%"><c:choose>
																			<c:when test="${vo.read =='9'}">
																				<i
																					class="fa fa-envelope-open-o font-18 align-middle mr-10"></i>
																			</c:when>
																			<c:otherwise>
																				<i class="fa fa-envelope font-18 align-middle mr-10"
																					style="color: #7571F9"></i>
																			</c:otherwise>
																		</c:choose></td>
																	...
																	<td width="55%" style="text-align: left;"><c:choose>
																			<c:when test="${vo.read =='9'}">
																	...
																	<td style="display: none;"><c:out
																			value="${vo.mailId}" /><input type="hidden"
																		id="mailId" name="mailId" value="${vo.mailId}" /></td>
																</tr>
															</c:forEach>
														</c:when>
														<c:otherwise>
