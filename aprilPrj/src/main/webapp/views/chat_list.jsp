        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="card" style="margin-bottom: 20px; ">
                    <div class="card-body" style="padding:20px; padding-bottom:0px; " >
                        <div class="media align-items-center mb-4" style="padding-left:20px; margin-bottom:5px; ">
                            <img class="mr-3" src="${hContext}/views/images/avatar/11.png" width="80" height="80" alt="">
                            <div class="media-body" style="padding-left: 20px;">
	                            <table class >
	                       			<tbody>
		                        		<tr><td><strong class="text-dark mr-4">&emsp;이름</strong><span>${user.name }</span></td></tr>
		                           		<tr><td class="mb-1" ><strong class="text-dark mr-4">&emsp;부서</strong><span>${user.deptNm }</span></td></tr>
		                            	<tr><td class="mb-1" ><strong class="text-dark mr-4">&emsp;직급</strong><span>${user.position }</span></td></tr>	
		                            	<tr><td class="mb-1" ><strong class="text-dark mr-4">&ensp;Email</strong><span>${user.email }</span></td>
	                            	</tbody>
	                        	</table>
                            </div>
                        </div>
    			...
    			<div class="card" style="margin-top: 20px; margin-bottom: 20px;">		
				    <form action = "${hContext}/chat/do_retrieve.do" name="dNameForm" method="get" class="form-inline" 
			     		  onchange="doRetrieve();" style="padding-left: 5%; padding-top:10px; padding-bottom:10px;">
			     		<strong class="text-dark mr-2">부서 선택&ensp;</strong>
							...
							<button style="margin-right:0.5em; text-align:center; height: 40px;" 
								     ...
								     <select name="searchDiv" id="searchDiv" onchange="doRetrieve()">
						...
						<c:when test="${list.size()>0 }">
							<c:forEach var="vo" items="${list }">
								<tr>
									...
									<td class="text-left"><c:out value="${vo.name }" /></td>
									<td class="text-center"><c:out value="${vo.dept_Nm }" /></td>
									<td class="text-center hidden-sm hidden-xs  "><c:out value="${vo.position }" /></td>
								</tr>
							</c:forEach>
						</c:when>
						<c:otherwise>
