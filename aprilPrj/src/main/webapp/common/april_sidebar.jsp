...
<!-- sidebar start  -->
             <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">다음페이지</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="${hContext}/dash/do_selectone.do">다음페이지</a></li>
                            <li><a href="${hContext}/admin/do_retrieve.do?pageNum=1&pageSize=10&searchDiv=&searchWord=">다음페이지</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
