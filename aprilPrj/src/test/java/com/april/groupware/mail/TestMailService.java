...
//		String read
		...
		//참조 없는 메일
		mail01 = new MailVO("","mail","이상무","leesm","","제목01","","내용01","홍길동","honggd","","N","0");
		mail02 = new MailVO("","mail","김주희","kimjh","","제목02","","내용02","이지은","leeje","","N","0");
		//참조 있는 메일
		mail03 = new MailVO("","mail","이재원","leejw","","제목03","","내용03","양은영,정수연","yangey,jungsy","","N","0");
		mail04 = new MailVO("","mail","김민지","kimmj","","제목04","","내용04","박지수,홍승민,정진우","parkjs,hongsm,jungjw","","N","0");
...
//		flag += this.mailRecService.doInsert(mail04);
	 ...
	 * 작성일: 2020. 5. 8.
	 * 작성자: MINJI
	 * 설명: 메일 단건 조회 (List에서 클릭했을 시)
	 * @throws java.lang.Exception
	 */
	@Test
	@Ignore
	public void doSelectOne() {
		//MailRecipientVO inVO = new MailRecipientVO("M200508_01","","이상무","leesm","","","","","M200508_01_R1","홍길동","honggd","","","0");
...
//		LOG.debug("=================Test doSelectOne End===================");
	...
	public void doDelete() {
		...
		//1. 삭제할 메일
		//String mail_seq, String mail_id, String receiver, String receiver_id, String rec_date
		//RecipientVO recipientVO = new RecipientVO("M200508_01_R1","M200508_01","홍길동","honggd","");
