...
public class TestNBoardDao {
	...
	public void doRetrieve() {
		...
		SearchVO  searchVO = new SearchVO(10,1,"게시","10");
	...
	public void doSelectOne() {
		...
		nboard01.setNbNo(32);
		NBoardVO vsVO = (NBoardVO) dao.doSelectOne(nboard01);
	}
	...
	public void doUpdate() {
		...
		nboard01.setNbNo(32);
		nboard01.setNbTitle(nboard01.getNbTitle()+"_d");
		
		flag = dao.doUpdate(nboard01);
...
//		LOG.debug("-------------------------");
	...
	public void setUp() throws Exception {
		...
		LOG.debug("^^^^^^^^^^^");
		nboard01=new NBoardVO(1,"게시글말머리01","게시글제목01","J01_내요오오오옹","1","1","",0,"작성자01","","20200510","");
		nboard02=new NBoardVO(2,"게시글말머리02","게시글제목02","J02_내요오오오옹","1","1","",0,"작성자02","","20200510","");
		nboard03=new NBoardVO(3,"게시글말머리03","게시글제목03","J03_내요오오오옹","1","1","",0,"작성자03","","20200510","");
		
		nboard04=new NBoardVO(4,"게시글말머리04","게시글제목04","J04_내요오오오옹","1","1","",0,"작성자04","","20200510","");
